...
initialization
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetExportDocTDRequest_DocType_Type),'GetExportDocTDRequest_DocType_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetExportDocDDRequest_DocType_Type),'GetExportDocDDRequest_DocType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderTDType_LabelResponseType_Type),'ShipmentOrderTDType_LabelResponseType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderDDType_LabelResponseType_Type),'ShipmentOrderDDType_LabelResponseType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderDDType_PRINTONLYIFCODEABLE_Type),'ShipmentOrderDDType_PRINTONLYIFCODEABLE_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_Dutiable_Type),'ShipmentDetailsTDType_Dutiable_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(EndorsementServiceconfiguration_active_Type),'EndorsementServiceconfiguration_active_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(EndorsementServiceconfigurationTeZu_active_Type),'EndorsementServiceconfigurationTeZu_active_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_Unfree_Type_PaymentType_Type),'DDServiceGroupOtherType_Unfree_Type_PaymentType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_Bulkfreight_Type_BulkfreightType_Type),'DDServiceGroupOtherType_Bulkfreight_Type_BulkfreightType_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentTDType_InvoiceType_Type),'ExportDocumentTDType_InvoiceType_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentTDType_ExportType_Type),'ExportDocumentTDType_ExportType_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentDDType_InvoiceType_Type),'ExportDocumentDDType_InvoiceType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentDDType_ExportType_Type),'ExportDocumentDDType_ExportType_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PickupBookingInformationType_ProductID_Type),'PickupBookingInformationType_ProductID_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetManifestDDRequest_manifestDateRange_Type),'GetManifestDDRequest_manifestDateRange_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderTDType_Shipment_Type),'ShipmentOrderTDType_Shipment_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderTDType_Pickup_Type),'ShipmentOrderTDType_Pickup_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderTDType),'ShipmentOrderTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderDDType_Shipment_Type),'ShipmentOrderDDType_Shipment_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderDDType_Pickup_Type),'ShipmentOrderDDType_Pickup_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentOrderDDType),'ShipmentOrderDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipperType),'ShipperType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipperTDType),'ShipperTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipperDDType),'ShipperDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ReceiverType),'ReceiverType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ReceiverTDType),'ReceiverTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ReceiverDDType),'ReceiverDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(IdentityType),'IdentityType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsType),'ShipmentDetailsType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_Account_Type),'ShipmentDetailsTDType_Account_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_AccountPaidBy_Type),'ShipmentDetailsTDType_AccountPaidBy_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType),'ShipmentDetailsTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsDDType_Attendance_Type),'ShipmentDetailsDDType_Attendance_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsDDType),'ShipmentDetailsDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentItemType),'ShipmentItemType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentItemTDType),'ShipmentItemTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentItemDDType),'ShipmentItemDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentServiceTD),'ShipmentServiceTD');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(TDServiceGroupDateTimeOptionType_ExpressSaturday_Type),'TDServiceGroupDateTimeOptionType_ExpressSaturday_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(TDServiceGroupDateTimeOptionType),'TDServiceGroupDateTimeOptionType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(TDServiceGroupOtherType_Insurance_Type),'TDServiceGroupOtherType_Insurance_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(TDServiceGroupOtherType),'TDServiceGroupOtherType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentServiceDD),'ShipmentServiceDD');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDateTimeOptionType_DeliveryOnTime_Type),'DDServiceGroupDateTimeOptionType_DeliveryOnTime_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDateTimeOptionType),'DDServiceGroupDateTimeOptionType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_Ident_Type),'DDShipmentServiceGroupIdentType_Ident_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_IdentExtra_Type),'DDShipmentServiceGroupIdentType_IdentExtra_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_IdentPremium_Type),'DDShipmentServiceGroupIdentType_IdentPremium_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_ContractSubmission_Type),'DDShipmentServiceGroupIdentType_ContractSubmission_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_SMSAviso_Type),'DDShipmentServiceGroupIdentType_SMSAviso_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType_CheckMinimumAge_Type),'DDShipmentServiceGroupIdentType_CheckMinimumAge_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupIdentType),'DDShipmentServiceGroupIdentType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDShipmentServiceGroupPickupType),'DDShipmentServiceGroupPickupType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupBusinessPackInternationalType_Endorsement_Type),'DDServiceGroupBusinessPackInternationalType_Endorsement_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupBusinessPackInternationalType),'DDServiceGroupBusinessPackInternationalType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDHLPaketType_ShipmentAdvisory_Type_AdvisoryData_Type),'DDServiceGroupDHLPaketType_ShipmentAdvisory_Type_AdvisoryData_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDHLPaketType_Endorsement_Type),'DDServiceGroupDHLPaketType_Endorsement_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDHLPaketType),'DDServiceGroupDHLPaketType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(EndorsementServiceconfiguration),'EndorsementServiceconfiguration');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(EndorsementServiceconfigurationTeZu),'EndorsementServiceconfigurationTeZu');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_HigherInsurance_Type),'DDServiceGroupOtherType_HigherInsurance_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_COD_Type),'DDServiceGroupOtherType_COD_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_Unfree_Type),'DDServiceGroupOtherType_Unfree_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_DangerousGoods_Type),'DDServiceGroupOtherType_DangerousGoods_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType_Bulkfreight_Type),'DDServiceGroupOtherType_Bulkfreight_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupOtherType),'DDServiceGroupOtherType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentNotificationType),'ShipmentNotificationType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentTDType_ExportDocPosition_Type),'ExportDocumentTDType_ExportDocPosition_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentTDType),'ExportDocumentTDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentDDType_ExportDocPosition_Type),'ExportDocumentDDType_ExportDocPosition_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentDDType),'ExportDocumentDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(FurtherAddressesDDType_DeliveryAdress_Type),'FurtherAddressesDDType_DeliveryAdress_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(FurtherAddressesDDType),'FurtherAddressesDDType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(LabelData),'LabelData');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocData),'ExportDocData');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ManifestState),'ManifestState');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DeletionState),'DeletionState');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PickupDetailsType),'PickupDetailsType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PickupAddressType),'PickupAddressType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PickupOrdererType),'PickupOrdererType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PickupBookingInformationType),'PickupBookingInformationType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(IdentityData_DrivingLicense_Type),'IdentityData_DrivingLicense_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(IdentityData_IdentityCard_Type),'IdentityData_IdentityCard_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(IdentityData_BankCard_Type),'IdentityData_BankCard_Type');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(IdentityData),'IdentityData');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PackstationType),'PackstationType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(PostfilialeType),'PostfilialeType');
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(CreateShipmentTDRequest_ShipmentOrderArray),'CreateShipmentTDRequest_ShipmentOrderArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(CreateShipmentResponse_CreationStateArray),'CreateShipmentResponse_CreationStateArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DeleteShipmentTDRequest_ShipmentNumberArray),'DeleteShipmentTDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DeleteShipmentResponse_DeletionStateArray),'DeleteShipmentResponse_DeletionStateArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DeleteShipmentDDRequest_ShipmentNumberArray),'DeleteShipmentDDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DoManifestTDRequest_ShipmentNumberArray),'DoManifestTDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DoManifestDDRequest_ShipmentNumberArray),'DoManifestDDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetLabelTDRequest_ShipmentNumberArray),'GetLabelTDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetLabelDDRequest_ShipmentNumberArray),'GetLabelDDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetExportDocTDRequest_ShipmentNumberArray),'GetExportDocTDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(GetExportDocDDRequest_ShipmentNumberArray),'GetExportDocDDRequest_ShipmentNumberArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(CreationState_StatusMessageArray),'CreationState_StatusMessageArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(CreationState_PieceInformationArray),'CreationState_PieceInformationArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_ShipmentItemArray),'ShipmentDetailsTDType_ShipmentItemArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_ServiceArray),'ShipmentDetailsTDType_ServiceArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsTDType_NotificationArray),'ShipmentDetailsTDType_NotificationArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsDDType_ShipmentItemArray),'ShipmentDetailsDDType_ShipmentItemArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsDDType_ServiceArray),'ShipmentDetailsDDType_ServiceArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ShipmentDetailsDDType_NotificationArray),'ShipmentDetailsDDType_NotificationArray');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(DDServiceGroupDHLPaketType_ShipmentAdvisory_Type),'DDServiceGroupDHLPaketType_ShipmentAdvisory_Type');
  ...
  typeRegistryInstance.Register(sNAME_SPACE,TypeInfo(ExportDocumentTDType_ExportDocPositionArray),'ExportDocumentTDType_ExportDocPositionArray');
