...
initialization
  ...
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(DoManifestResponse),'DoManifestResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(DoManifestDDRequest),'DoManifestDDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetLabelTDRequest),'GetLabelTDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetLabelResponse),'GetLabelResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetLabelDDRequest),'GetLabelDDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(BookPickupRequest),'BookPickupRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(BookPickupResponse),'BookPickupResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(CancelPickupRequest),'CancelPickupRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(CancelPickupResponse),'CancelPickupResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetVersionResponse),'GetVersionResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetExportDocTDRequest),'GetExportDocTDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetExportDocResponse),'GetExportDocResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetExportDocDDRequest),'GetExportDocDDRequest');
  ...
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetManifestDDRequest),'GetManifestDDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(GetManifestDDResponse),'GetManifestDDResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(UpdateShipmentDDRequest),'UpdateShipmentDDRequest');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(UpdateShipmentResponse),'UpdateShipmentResponse');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(DeveloperAuthentification),'DeveloperAuthentification');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(CreationState),'CreationState');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(Statusinformation),'Statusinformation');
  typeRegistryInstance.Register(sEMPTY_NAME_SPACE,TypeInfo(PieceInformation),'PieceInformation');
