...
const
  // DeleteShipmentOrderRequest_shipmentNumberArray wird expilzit für cisbase registriert
  sCIS_BASE = 'http://dhl.de/webservice/cisbase';
...
type
  ...
  private
    ...
    FcodAmount : Currency; //ServiceconfigurationCashOnDelivery_codAmount_Type;
  private
  ...
  DeletionState = class(DeletionStateCISBase)
  private
    // Element erhält den cisbase-Namespace und wird in DeletionStateCISBase deklariert
    //FshipmentNumber : shipmentNumber_Type;
    FStatus : Statusinformation;
  public
    constructor Create();override;
...
begin
  //cisbase-Namespace explizit angeben
  AStore.Put(sCIS_BASE,'shipmentNumber',TypeInfo(shipmentNumber_Type),FData[AIndex]);
end;
...
initialization
  ...
  typeRegistryInstance.Register(sCIS_BASE,TypeInfo(DeleteShipmentOrderRequest_shipmentNumberArray),'DeleteShipmentOrderRequest_shipmentNumberArray',[trioqualifiedElement, triounqualifiedAttribute]);
