...
begin
  ...
  // Auftragsdaten
  AccountNumber.SetByString(intraship_services_const.ACCOUNT_NUMBER);
  EKP.SetByString(intraship_services_const.EKP);
  ...
  Postnumber.SetByString(intraship_services_const.POSTNUMBER);
